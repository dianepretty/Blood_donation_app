...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
          create: (context) => AppointmentBloc(appointmentService: AppointmentService(), hospitalService: HospitalService())..add(LoadAdminAppointments('put hospital name of logegd user')),
        ),
        BlocProvider(
          create:
